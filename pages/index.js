...
export default function Home() {
  ...
  async function buyNft(nft) {
    ...
    console.log(nftaddress,nft.tokenId,paymentTokenAddress)
    ...
    loadNFTs()
      ...
      console.log(err.message ,nftaddress,nft.tokenId,paymentTokenAddress)
    }
    ...
    <div className="flex justify-center animate-loadtransition">
      <div className="px-25 md:px-28 pb-6 " style={{ maxWidth: '1600px' }}>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 items-start gap-10 pt-4">
          {
            nfts.map((nft, i) => (
              <div key={i} className="group shadow-xl shadow-purple-500/20 hover:shadow-purple-500/60 rounded-lg overflow-hidden transform transition duration-500 bg-gray-500 bg-opacity-5 hover:bg-opacity-15">                
                <div className="flex justify-center overflow-hidden rounded-md m-2">
